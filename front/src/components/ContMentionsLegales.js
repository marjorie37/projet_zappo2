...
class ContMentionsLegales extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  render() {
    ...
    return (
      <div>
        <RootContainer justify="space-between">
          <MainHeader
            image={imageOpen}
            pageTitle="CGV"
            ...
            <Grid item xs={11}>
              <Paper style={{ padding: "15px" }}>
                ...
                <Typography component="p">
                  ...
                  aux utilisateurs du site commande.zappo.fr l’identité des
                  différents intervenants dans le cadre de sa réalisation et de
                  son suivi : Propriétaire : Société Zappo – – 6 Rue Challemel
                  Lacour, 69007 Lyon Responsable publication : Société Zappo –
                  06 60 06 60 06 Le responsable publication est une personne
                  physique ou une personne morale. Webmaster : Hébergeur : OVH –
                ...
                <Typography component="p">
                  L’utilisation du site commande.zappo.fr implique l’acceptation
                  ...
                  utilisateurs du site commande.zappo.fr sont donc invités à les
                  consulter de manière régulière. Ce site est normalement
                  accessible à tout moment aux utilisateurs. Une interruption
                  pour raison de maintenance technique peut être toutefois
                  décidée par Société Licorne et Papillons, qui s’efforcera
                  alors de communiquer préalablement aux utilisateurs les dates
                  et heures de l’intervention. Le site commande.zappo.fr est mis
                  à jour régulièrement par Société Licorne et Papillons. De la
                ...
                <Typography component="p">
                  Le site commande.zappo.fr a pour objet de fournir une
                  information concernant l’ensemble des activités de la société.
                  Société Zappo s’efforce de fournir sur le site
                  commande.zappo.fr des informations aussi précises que
                  ...
                  informations indiquées sur le site commande.zappo.fr sont
                  données à titre indicatif, et sont susceptibles d’évoluer. Par
                  ailleurs, les renseignements figurant sur le site
                  commande.zappo.fr ne sont pas exhaustifs. Ils sont donnés sous
                  réserve de modifications ayant été apportées depuis leur mise
                  en ligne.
                </Typography>
                <Typography variant="title" style={{ marginTop: "1rem" }}>
                ...
                <Typography component="p">
                  ...
                  autorisation écrite préalable de : Société Zappo. Toute
                ...
                <Typography component="p">
                  Société Zappo ne pourra être tenue responsable des dommages
                  directs et indirects causés au matériel de l’utilisateur, lors
                  de l’accès au site commande.zappo.fr, et résultant soit de
                  l’utilisation d’un matériel ne répondant pas aux
                  spécifications indiquées au point 4, soit de l’apparition d’un
                  bug ou d’une incompatibilité. Société Zappo ne pourra
                  également être tenue responsable des dommages indirects (tels
                  par exemple qu’une perte de marché ou perte d’une chance)
                  consécutifs à l’utilisation du site commande.zappo.fr. Des
                  espaces interactifs (possibilité de poser des questions dans
                  l’espace contact) sont à la disposition des utilisateurs.
                  Société Zappo se réserve le droit de supprimer, sans mise en
                  ...
                  données. Le cas échéant, Société Licorne et Papillons se
                ...
                <Typography component="p">
                  ...
                  Européenne du 24 octobre 1995. A l’occasion de l’utilisation
                  du site commande.zappo.fr, peuvent êtres recueillies : l’URL
                  des liens par l’intermédiaire desquels l’utilisateur a accédé
                  au site commande.zappo.fr, le fournisseur d’accès de
                  l’utilisateur, l’adresse de protocole Internet (IP) de
                  l’utilisateur. En tout état de cause Société Zappo ne collecte
                  des informations personnelles relatives à l’utilisateur que
                  pour le besoin de certains services proposés par le site
                  commande.zappo.fr. L’utilisateur fournit ces informations en
                  toute connaissance de cause, notamment lorsqu’il procède par
                  lui-même à leur saisie. Il est alors précisé à l’utilisateur
                  du site commande.zappo.fr l’obligation ou non de fournir ces
                  ...
                  commande.zappo.fr n’est publiée à l’insu de l’utilisateur,
                  échangée, transférée, cédée ou vendue sur un support
                  quelconque à des tiers. Seule l’hypothèse du rachat de Société
                  Zappo et de ses droits permettrait la transmission des dites
                  ...
                  données vis à vis de l’utilisateur du site commande.zappo.fr.
                  Le site n’est pas déclaré à la CNIL car il ne recueille pas
                  d’informations personnelles. . Les bases de données sont
                ...
                <Typography component="p">
                  Le site commande.zappo.fr contient un certain nombre de liens
                  hypertextes vers d’autres sites, mis en place avec
                  l’autorisation de Société Zappo. Cependant, Société Zappo n’a
                  pas la possibilité de vérifier le contenu des sites ainsi
                  visités, et n’assumera en conséquence aucune responsabilité de
                  ce fait. La navigation sur le site commande.zappo.fr est
                  ...
                  de fréquentation. Le refus d’installation d’un cookie peut
                  ...
                  Validez sur Ok. Sous Firefox : en haut de la fenêtre du
                  navigateur, cliquez sur le bouton Firefox, puis aller dans
                  l’onglet Options. Cliquer sur l’onglet Vie privée. Paramétrez
                  les Règles de conservation sur : utiliser les paramètres
                  personnalisés pour l’historique. Enfin décochez-la pour
                  désactiver les cookies. Sous Safari : Cliquez en haut à droite
                  du navigateur sur le pictogramme de menu (symbolisé par un
                  rouage). Sélectionnez Paramètres. Cliquez sur Afficher les
                  paramètres avancés. Dans la section « Confidentialité »,
                  cliquez sur Paramètres de contenu. Dans la section « Cookies
                  », vous pouvez bloquer les cookies. Sous Chrome : Cliquez en
                  haut à droite du navigateur sur le pictogramme de menu
                  (symbolisé par trois lignes horizontales). Sélectionnez
                  Paramètres. Cliquez sur Afficher les paramètres avancés. Dans
                  la section « Confidentialité », cliquez sur préférences. Dans
                ...
                <Typography component="p">
                  ...
                  commande.zappo.fr est soumis au droit français. Il est fait
...
export default ContMentionsLegales;
