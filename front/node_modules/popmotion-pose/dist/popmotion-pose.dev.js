(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var linear$2 = easing.linear, easeIn$1 = easing.easeIn, easeOut$1 = easing.easeOut, easeInOut$1 = easing.easeInOut, circIn$1 = easing.circIn, circOut$1 = easing.circOut, circInOut$1 = easing.circInOut, backIn$1 = easing.backIn, backOut$1 = easing.backOut, backInOut$1 = easing.backInOut, anticipate$1 = easing.anticipate;
    var easingLookup = {
        linear: linear$2,
        easeIn: easeIn$1,
        easeOut: easeOut$1,
    ...
    var makePointerEvent = function (_a) {
        var startEvents = _a.startEvents, endEvents = _a.endEvents, startPose = _a.startPose, endPose = _a.endPose, startCallback = _a.startCallback, endCallback = _a.endCallback, startListener = _a.startListener, endListener = _a.endListener, useDocumentToEnd = _a.useDocumentToEnd;
    ...
    var makeDraggable = makePointerEvent({
    ...
    var makeHoverable = makePointerEvent({
    ...
    var appendEventListeners = (function (element, activeActions, setPose, _a) {
        ...
        if (props.hoverable)
            makeHoverable(element, activeActions, setPose, props);
    });
    ...
    var createPoseConfig = function (element, _a) {
        var onDragStart = _a.onDragStart, onDragEnd = _a.onDragEnd, draggable = _a.draggable, onHoverStart = _a.onHoverStart, onHoverEnd = _a.onHoverEnd, hoverable = _a.hoverable, dragBounds = _a.dragBounds, config = __rest(_a, ["onDragStart", "onDragEnd", "draggable", "onHoverStart", "onHoverEnd", "hoverable", "dragBounds"]);
